...
public struct Token(Token.Type type, TokenInfo info, object? value)
{
  public enum Type {
    ...
    BREAK, CONTINUE, SWITCH, CASE, DEFAULT, RAWC, EXTERN, ENUM, ERROR, TRY, CATCH,
    ...
    PLUS, MINUS, EXCLAMATION, TILDE, AMPER, SIZEOF, QUESTION, ISNULL, AT,
  ...
  private static readonly Dictionary<Type, Token> INSTANCES = new()
  {
    ...
    [Type.INFER] = new(Type.INFER),
    [Type.WHILE] = new(Type.WHILE),
    [Type.DO] = new(Type.DO),
    ...
    [Type.SWITCH] = new(Type.SWITCH),
    [Type.CASE] = new(Type.CASE),
    [Type.DEFAULT] = new(Type.DEFAULT),
    ...
    [Type.CINCLUDE] = new(Type.CINCLUDE),
    ...
    [Type.TRY] = new(Type.TRY),
    [Type.CATCH] = new(Type.CATCH),
  };
